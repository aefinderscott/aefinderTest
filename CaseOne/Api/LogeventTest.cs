...
namespace CaseOne.Api
{
    ...
    public class LogeventTestTests : BaseTestSetup
    {
        ...
        public void testLogeventsQuery_Test()
        {
            ...
            JArray result2 = HttpRequest.BaseUrl("http://192.168.71.156:8081").Path("/api/app/block/logevents")
        ...
        public void testLogeventsQueryConfirm_Test()
        {
            JObject param = new JObject();
        ...
        public void testLogeventsQuerySgtE_Test()
        {
            JObject param = new JObject();
        ...
        public void testLogeventsQueryNoStart_Test()
        {
            JObject param = new JObject();
            ...
            JObject result2 = HttpRequest.BaseUrl("http://192.168.71.156:8081").Path("/api/app/block/logevents")
                                                    .ContentType("application/json")
                                                    .Params(param).Exec(oneCaseDto).ToJObject();
        ...
        public void testLogeventsQueryNoEnd_Test()
        {
            JObject param = new JObject();
        ...
        public void testLogeventsQueryWrongChainId_Test()
        {
            JObject param = new JObject();
        ...
        public void testLogeventsQueryNotExist_Test()
        {
            JObject param = new JObject();
